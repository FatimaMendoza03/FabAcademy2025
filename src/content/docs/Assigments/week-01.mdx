...
As part of the Emergency Drone Project, they have anthenas drones who needs a tethered system to be able to proveide a constant and secure source of power. 
The currect sistem is a cable that needs to be unroll manually and connected to a power supply and after using it, it needs to be roll again manually, but this is not effecient to use in a long term. 
...
There are elements that are neccesary like:
- Input power socket
...
Knowing this elements I continue to do an sketch showing how the elements can be positioned. The sketch I made it with [Obsidian](https://obsidian.md/) and it turn out like this: 
