...
For this week I decided to design and cut the plates in plywood to do the prototype of the tethered box.

Firs I designed in Fusion 360 the plates...

After having the design ready, I export it as 

### Machine process

The laser cut machine in the Green FabLab requires a specific program and license, so we use a specific computer that has everything we need to operate the machine. As I was learning they recommended me to check the [Instruction manual for the Laser Cutter](https://wiki.fablab.green/doku.php?id=maschinen:lasercutter). If you want to use this machine I would recommend to also check it since they have very valuable information.



![Step one](./week-03/laser_1.jpeg)

![Step one](./week-03/laser_2.jpeg)

![Step one](./week-03/laser_3.jpeg)

![Step one](./week-03/laser_4.jpeg)

![Step one](./week-03/laser_5.jpeg)

![Step one](./week-03/laser_6.jpeg)

![Step one](./week-03/laser_7.jpeg)

![Step one](./week-03/laser_8.jpeg)

![Step one](./week-03/laser_9.jpeg)

![Step one](./week-03/laser_10.jpeg)

![Step one](./week-03/laser_11.jpeg)

![Step one](./week-03/laser_11_5.jpeg)

![Step one](./week-03/laser_12.jpeg)

![Step one](./week-03/laser_13.jpeg)

![Step one](./week-03/laser_14.jpeg)
